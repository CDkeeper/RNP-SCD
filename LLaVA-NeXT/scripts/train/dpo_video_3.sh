...
export WANDB_PROJECT=llava-onevision-dpo_our
...
DPO_RUN_NAME="LLaVA-onevision-7B-Qwen2_dpo-beta${beta}-epoch${EPOCH}"
DPO_CLEAN_NAME="${DPO_RUN_NAME##*/}"
OUTPUT_DIR="./work_dirs3/${DPO_CLEAN_NAME}_our"
...
DATA_PATH="/mnt/data1/chenda/codes/LLaVA-NeXT/final_dpo_11_15.yaml"
echo $DPO_RUN_NAME
