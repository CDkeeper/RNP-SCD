...
export WANDB_PROJECT=llava-video-dpo
...
OUTPUT_DIR="./work_dirs2/${DPO_CLEAN_NAME}_2"
...
DATA_PATH="/mnt/data1/chenda/codes/LLaVA-NeXT/test_train2.yaml"
echo $DPO_RUN_NAME
...
deepspeed --master_port 30000 \
    --include localhost:0,1,2,3,4,6,7 \
